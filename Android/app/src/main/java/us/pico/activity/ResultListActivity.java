...
import us.pico.R;
import us.pico.adapter.ResultListAdapter;
import us.pico.fragment.MapSearchFragment;
...
public class ResultListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ResultListAdapter listAdapter = new ResultListAdapter(this,
                android.R.layout.simple_list_item_1, MapSearchFragment.s_ResultList);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        DiscoveryResult result = MapSearchFragment.s_ResultList.get(position);
    ...
    private ResultListener<Place> m_placeResultListener = new ResultListener<Place>() {
        ...
        public void onCompleted(Place place, ErrorCode errorCode) {
            if (errorCode == ErrorCode.NONE) {
                ...
                Intent intent = new Intent(ResultListActivity.this,Navigation.class);
